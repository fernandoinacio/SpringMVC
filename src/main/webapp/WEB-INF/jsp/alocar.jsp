            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div>
                                <h5>Resposta ao pedido</h5>
                               
                            </div>
                            <form class="mt-5" action="alocar?id=${req.cod_req}" method="post" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        <div class="form-group">
                                            <h5>Atribuir motorista <span class="text-danger">*</span></h5>
                                            <div class="controls">

                                                <select name="codMot" id="select" required class="form-control" data-validation-required-message="Preencha o campo">
                                                    <c:forEach var="motoristas" items="${motoristas}">
                                                        <option value="${motoristas.cod_mt}">${motoristas.nome_mt}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md">
                                        <div class="form-group">
                                            <h5>Titulo da Mensagem <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <input type="text" name="titulo_msg" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Indique um titulo a mensagem"> </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="resposta" class="form-control" rows="4" required data-validation-required-message="Preencha o campo"></textarea> </div>
                                        </div>
                                    </div>  
