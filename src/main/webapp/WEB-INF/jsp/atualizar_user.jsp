...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Sistema PV | Edicao de Usuario </title>
        <!-- Bootstrap Core CSS -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Atualizacao de Usuario</h4>
                                    <form class="mt-5" action="atualizar" method="post" novalidate>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>Nome do Usuario <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="nome_user" class="form-control" required data-validation-required-message="Preencha o campo" value="${edit.nome_user}"> </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="func.dept.nome_dept" id="select" required class="form-control" data-validation-required-message="Preencha o campo">
                                                            <option value="${edit.func.dept.nome_dept}">${edit.func.dept.nome_dept}</option>
                                                            <option value="Financas">Financas</option>
                                                            <option value="Manutencao">Manutencao</option>
                                                            <option value="Transportes">Transportes</option>
                                                            <option value="Administracao">Administracao</option>
                                                            <option value="Gabinete Tecnico">Gabinete Tecnico</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="email" name="email_user" class="form-control" required data-validation-required-message="Preencha o campo" value="${edit.email_user}"> </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="func.cargo_func" class="form-control" required data-validation-required-message="Preencha o campo" value="${edit.func.cargo_func}"> </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="password" name="senha_user" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="**********" value="${edit.senha_user}"> </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <h5>Tipo de Usuario <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <select name="tipo_user" id="select" required class="form-control" data-validation-required-message="Preencha o campo">
                                                            <option value="${edit.tipo_user}">${edit.tipo_user}</option>
                                                            <option value="Administrador">Administrador</option>
                                                            <option value="Usuario">Usuario-Gestor</option>
                                                            <option value="Usuario simples">Usuario simples</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="password" name="confSenha" data-validation-match-match="password" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="**********" value="${edit.confSenha}"> </div>
                                                </div>
                                            </div>
