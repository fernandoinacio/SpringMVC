...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Sistema PV | Edicao de Viatura </title>
        <!-- Bootstrap Core CSS -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="mt-5" action="atualizar-viatura" method="POST" novalidate>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="marca" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Digite a marca da viatura..." value="${edit.marca}"> </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="modelo" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Digite o modelo da viatura..." value="${edit.modelo}"> </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="tipo_combustivel" id="select" required class="form-control" data-validation-required-message="Preencha o campo">
                                                            <option value="${edit.tipo_combustivel}">${edit.tipo_combustivel}</option>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="cor" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Digite a cor da viatura..." value="${edit.cor}"> </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="number" name="nr_assentos" max="20" min="2" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Digite a cor da viatura..." value="${edit.nr_assentos}"> </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="data_aquisicao" class="form-control date-inputmask" required data-validation-required-message="Preencha o campo" id="date-mask" placeholder="dd/mm/yyyy" value="${edit.data_aquisicao}"></div>
                                                ...
                                                <div class="form-group" >
                                                    ...
                                                    <div class="controls">
                                                        <input type="number" name="ano_fabrico" max="5000" 
                                                               min="1900" class="form-control" required data-validation-required-message="Preencha o campo"  id="ano_fabrico" placeholder="Ano de fabrico" value="${edit.ano_fabrico}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="tipo_vt" id="select" required class="form-control" data-validation-required-message="Preencha o campo">
                                                            <option value="${edit.tipo_vt}">${edit.tipo_vt}</option>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="matricula" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Digite a cor da viatura..." value="${edit.matricula}"> </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="5" name="obs_vt" value="${edit.obs_vt}"></textarea>
                                                </div>
                                            </div>
                                        </div>
