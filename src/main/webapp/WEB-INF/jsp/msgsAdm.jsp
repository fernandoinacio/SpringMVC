                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-body printableArea">
                                <h3><b>Requisicao</b> <span class="float-right"></span></h3>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="float-left">
                                            <address>
                                                <h3> &nbsp;${req.usu.nome_user}</h3>
                                                <p class="text-muted ml-1">${req.usu.func.cargo_func}
                                                    <br/> Departamento de ${req.usu.func.dept.nome_dept}
                                                    <br/> ${req.usu.email_user}
                                            </address>
                                        </div>
                                        <div class="float-right text-right">
                                            <address>
                                                <h3>Para,</h3>
                                                <h4 class="font-bold">${dest.nome_user}</h4>
                                                <p class="text-muted ml-4">${dest.func.cargo_func},
                                                    <br/> ${dest.func.dept.nome_dept},
                                                    <br/> ${dest.nome_user}</p>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="text-right">
                                            <a class="btn btn-danger" href="/SPVPetromoc/validar?id=${req.cod_req}">Enviar</a>
