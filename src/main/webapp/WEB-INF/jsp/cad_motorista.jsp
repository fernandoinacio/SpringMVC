...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Sistema PV | Cadastro de Motorista </title>
        <!-- Bootstrap Core CSS -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Cadastro de Motorista</h4>
                                    <form class="mt-5" novalidate action="cadastro-motorista" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="nome_mt" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Digite o nome do usuario..."> </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="date"  max="3000-12-31" min="1000-01-01" name="data_nasc_mt" class="form-control date-inputmask" required data-validation-required-message="Preencha o campo" id="date-mask" placeholder="dd/mm/yyyy"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="carta.nr_carta" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Digite o nr da carta..."> </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="cell_mt.cell" class="form-control" data-mask="(999) 999-999999" required data-validation-required-message="Preencha o campo"placeholder="(999) 999-999999">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="date"  max="3000-12-31" min="1000-01-01" name="carta.validade" class="form-control" required data-validation-required-message="Preencha o campo"  placeholder="dd/mm/yyyy"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="email" name="email_mt" class="form-control"  placeholder="Digite o email..."> </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="carta.local_emissao" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Digite o local de emissao..."> </div>
