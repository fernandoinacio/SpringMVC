<%-- 
    Document   : list_motoristas
    Created on : 30/set/2018, 15:31:50
    Author     : Nando Cortez
--%>
...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Sistema PV | Lista de Motoristas </title>
        <!-- Bootstrap Core CSS -->
                                            ...
                                            <tbody>
                                                <c:forEach var="lista" items="${lista}">
                                                    <tr>
                                                        <td>${lista.cod_mt}</td>
                                                        <td>${lista.nome_mt}</td>
                                                        <td>${lista.carta.tipo_carta}</td>
                                                        <td>${lista.carta.validade}</td>
                                                        <td>${lista.carta.nr_carta}</td>
                                                        <td>${lista.email_mt}</td>
                                                        <td><a href="/SPVPetromoc/remover-motorista?id=${lista.cod_mt}">Remover</a></td>
                                                        <td><a href="/SPVPetromoc/editar-motorista?id=${lista.cod_mt}">Editar</a></td>
