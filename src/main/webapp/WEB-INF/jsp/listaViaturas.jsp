...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Sistema PV | Disponibilidade </title>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="demo-foo-pagination" class="table table-bordered toggle-arrow-tiny" data-sorting="true" data-paging="true" data-paging-size="5">
                                    ...
                                    <tbody>
                                        <c:forEach var="listaDispo" items="${listaDispo}">
                                            <tr>
                                                <td>${listaDispo.vt.marca}</td>
                                                <td>${listaDispo.vt.modelo}</td>
                                                <td>${listaDispo.vt.tipo_combustivel}</td>
                                                <td>${listaDispo.vt.nr_assentos}</td>
                                                <td><span class="label label-table label-success" >Disponivel</span></td>
                                            </tr>
                                        </c:forEach>
                                        <c:forEach var="lista" items="${lista}">
                                            <tr>
                                                <td>${lista.vt.marca}</td>
                                                <td>${lista.vt.modelo}</td>
                                                <td>${lista.vt.tipo_combustivel}</td>
                                                <td>${lista.vt.nr_assentos}</td>
                                                <td><span class="label label-table label-danger">Em transito</span></td>
                                            </tr>
                                        </c:forEach>
