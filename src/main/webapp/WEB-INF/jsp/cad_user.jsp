...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Sistema PV | Cadastro de Usuario </title>
        <!-- Bootstrap Core CSS -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="mt-5" action="cadastro-usuario" method="post" novalidate>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="nome_user" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Digite o nome do usuario..."> </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="email" name="email_user" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Digite o email..."> </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="func.cargo_func" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="Digite o cargo do usuario..."> </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="password" name="senha_user" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="**********"> </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="password" name="confSenha" data-validation-match-match="password" class="form-control" required data-validation-required-message="Preencha o campo" placeholder="**********"> </div>
                                                </div>
                                            </div>
