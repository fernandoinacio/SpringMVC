                                                        ...
                                                        <tbody>
                                                            ...
                                                            <c:forEach var="recebidos" items="${recebidos}">
                                                                <tr class="unread" >
                                                                    ...
                                                                    <td class="max-texts"> <a href="/SPVPetromoc/mensagem?id=${recebidos.cod_req}"/> Recebeu uma mensagem</td>
                                                                    <td class="hidden-xs-down"></td>
                                                            ...
                                                            <c:forEach var="aceites" items="${aceites}">
                                                                <tr class="unread" >
                                                                    ...
                                                                    <td class="max-texts"> <a href="/SPVPetromoc/mensagem?id=${aceites.cod_req}"/> A sua requesicao foi aceite!</td>
                                                                    <td class="hidden-xs-down"></td>
                                                            ...
                                                            <c:forEach var="entradas" items="${entradas}">
                                                                <tr class="unread" >
                                                                    ...
                                                                    <td style="width:40px" class="hidden-xs-down"><i class="fa fa-star-o"></i></td>
                                                                    <td>${entradas.msgs_req[2].tipo_msg}</td>
                                                                    <td class="max-texts"> <a href="#"/> ${entradas.msgs_req[2].titulo_msg} </td>
                                                                    <td class="hidden-xs-down"></td>
                                                                    <td class="text-right"> ${entradas.msgs_req[2].data_msg} </td>
                                                                </tr>
                                                            </c:forEach>
                                                            <c:forEach var="saidas" items="${saidas}">
                                                                <tr class="unread" >
                                                                    ...
                                                                    <td class="max-texts"> <a href="#"/> ${saidas.msgs_req[0].titulo_msg} ${saidas.vt.marca} a ${saidas.prov_destino}  </td>
                                                                    <td class="hidden-xs-down"></td>
